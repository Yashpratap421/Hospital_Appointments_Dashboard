...
function Banner() {
  ...
  return (
    <div className="flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lgx-12 my-20 md-mx-10">
        <div className='flex-1 py-8 sm:py-10 md:py-32 lg:pl-5'>
          <div className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-white">
            <p>Book Appointment</p>
            <p className='mt-4 text-nowrap'>with 100+ Trusted Doctors</p>
          </div>
