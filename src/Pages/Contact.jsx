    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className='text-gray-500'>Tel: (415) 555-0132 <br /> Email: yash@gmail.com</p>
          <p className='text-gray-500'>Careers at PRESCRIPTO</p>
          <p>Learn more about our team and job opening.</p>
          <button className='border border-black px-8 py-4 textr-sm hover:bg-black hover:text-white transition-all duration-500'>Explore Job</button>
        </div>
      </div>
    </div>
  )
