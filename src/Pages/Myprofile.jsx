...
import {assets} from '../assets/assets-frontend/assets.js'
...
function Myprofile() {
  ...
  const [userData, setUserData] = useState({
    ...
    phone: '487641165411',
    address:{
      line1:"ejhwoijefwoiho ewijh nc",
      line2:"diyu8  0eiw wej0 ewi ",
    },
    gender:'Male',
    dob:'2000-01-20'
  })
const [isEdit , setIsEdit] = useState(false)
  return (
    <div  className='max-w-lg flex flex-col gap-2 text-sm '>
     ...
     { isEdit ?
      <p >
        <input className='bg-gray-50 ' onChange={prev => ({...prer, address:{...prev.address, line1: e.target.value}})} value={userData.address.line1} type="text" />
        <br />
        <input className='bg-gray-50' onChange={prev => ({...prer, address:{...prev.address, line2: e.target.value}})} value={userData.address.line2}  type="text" />
      </p>
     ...
     {
      isEdit ? <input type="date" className='max-w-28 bg-gray-100' onChange={e => setUserData(prev => ({...prev,dob:e.target.value}))}  value={userData.dob}/>
